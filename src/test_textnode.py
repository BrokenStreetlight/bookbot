...
class TestTextNode(unittest.TestCase):
    ...
    def test_image(self):
        node = TextNode(
            "image text", TextType.IMAGE, "https://www.google.com/image.jpg"
        )
        html_node = text_node_to_html_node(node)
        ...
        self.assertEqual(
            html_node.props,
            {"src": "https://www.google.com/image.jpg", "alt": "image text"},
        )
